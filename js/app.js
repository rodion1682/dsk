(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".our-product__slider")) new core(".our-product__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                loop: true,
                navigation: {
                    prevEl: ".our-product__arrow_left",
                    nextEl: ".our-product__arrow_right"
                },
                on: {}
            });
            if (document.querySelector(".countdown-slider__slider")) new core(".countdown-slider__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                loop: true,
                pagination: {
                    el: ".countdown-slider__dots",
                    clickable: true
                },
                on: {}
            });
            if (document.querySelector(".home-blog__slider")) new core(".home-blog__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 800,
                loop: true,
                navigation: {
                    prevEl: ".home-blog__arrow_left",
                    nextEl: ".home-blog__arrow_right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.05,
            ...
            if (document.querySelector(".navigation__slider")) new core(".navigation__slider", {
                ...
                navigation: {
                    prevEl: ".navigation__arrow_left",
                    nextEl: ".navigation__arrow_right"
                },
                on: {}
            });
            if (document.querySelector(".image-product")) {
                let smallSlider = new core(".image-product__slider-small", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: "auto",
                    ...
                    loop: true,
                    navigation: {
                        prevEl: ".image-product__arrow_left",
                        nextEl: ".image-product__arrow_right"
                    },
                    on: {}
                });
            ...
            if (document.querySelector(".home-review__slider")) {
                new core(".home-review__slider", {
                    modules: [ Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    loop: true,
                    pagination: {
                        el: ".home-review__dots",
                        clickable: true
                    },
                    on: {}
                });
                let mainsliderImages = document.querySelectorAll(".home-review__image");
                let mainsliderDots = document.querySelectorAll(".home-review__dots .swiper-pagination-bullet");
                for (let index = 0; index < mainsliderImages.length - 2; index++) {
...
***************************************************************************** */
        ...
        if (document.querySelector(".image-viewer__image-box")) {
            let images = document.querySelectorAll(".image-viewer__img");
